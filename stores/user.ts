...
import type { iUserFromStore } from '@/types/user';
...
export const useUserStore = defineStore('user', () => {
  ...
  return { userFromStore, userPacksCount, getUserForStore, setUserForStore, tradeCard, howManyOfXCardDoesUserHave, doesUserHaveXCard, shouldUserSeeEmergencyPacks, emergencyPacksAvailableToUser, hasUserCollectedXCard, isXCardInUserTeam, userTyres };
})