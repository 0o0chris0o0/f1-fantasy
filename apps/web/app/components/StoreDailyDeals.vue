    ...
    >
      ...
      <div v-if="userObj" class="mt-2">
        <Button 
          ...
          size="small"
          :disabled="deal.price > userObj.money"
...
import { iCardRarity, type iCardInUsersCards, type iConstructorCard, type iDailyDealCard, type iDriverCard, type WeekDay, type WeeklySchedule } from "@f1pick6/shared";
import {
  doc,
  getDoc,
