      ...
      <div v-if="rewardObj" class="text-white text-center px-6">
        ...
        <p class="mb-6 font-f1 text-xl">
          ...
          <span
            ...
            :class="{
              'text-amber-500':
                rewardObj.rewardType === RewardType.COINS ||
                rewardObj.rewardType === RewardType.PACK,
              'text-uncommon':
                rewardObj.rewardType === RewardType.CARDS &&
                rewardObj.key === iCardRarity.UNCOMMON,
              'text-rare':
                rewardObj.rewardType === RewardType.CARDS &&
                rewardObj.key === iCardRarity.RARE,
              'text-legendary':
                rewardObj.rewardType === RewardType.CARDS &&
                rewardObj.key === iCardRarity.LEGENDARY,
              'text-mythic':
                rewardObj.rewardType === RewardType.CARDS &&
                rewardObj.key === iCardRarity.MYTHIC,
            }"
          >
